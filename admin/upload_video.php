...
<head>
  ...
  <title>Admin - Upload Video Link</title>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="upload_video.php">Upload Video</a>
          </li>
        </ul>
      </div>
    </div>
...
<div class="admin-container">
    ...
    <form id="uploadForm" action="uploads3.php" method="POST" enctype="multipart/form-data">
        <!-- Video Link Input -->
        <div class="mb-3">
            <label for="video_link" class="form-label">Video Link</label>
            <input type="url" class="form-control" id="video_link" name="video_link" placeholder="Enter video link" required>
        </div>
