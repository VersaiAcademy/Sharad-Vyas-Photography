	...
	<section class="contact-section" >
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-5">
					<div class="contact-text max-w-3xl mx-auto text-center py-16 px-6 bg-white text-black rounded-lg shadow-lg">
						<!-- Sample animation -->
						
						
						 <!-- sample -->
						<h3 class="text-4xl font-semibold mb-4 tracking-wider text-black p-3">Get in Touch</h3>
						<p class="text-lg mb-8 leading-relaxed text-gray-700">
						  If you wish to connect, whether for professional inquiries or to share a passion for travel and photography, feel free to reach out. 
						  I am always open to engaging with like-minded individuals who share an interest in exploring life’s many facets. 
						  Your message is important, and I will get back to you as soon as possible.
						</p>
						<ul class="list-none space-y-4">
						  <li class="text-xl flex items-center justify-center">
							<span class="mr-2 text-black font-semibold">Email:</span>
							<span class="text-gray-600 hover:text-black transition duration-300">skvyasrjs2011@gmail.com</span>
						  </li>
						</ul>
					  </div>
